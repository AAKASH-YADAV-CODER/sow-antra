    ...
    <div className="properties-panel hidden md:block">
      ...
      {!selectedElementData ? (
        ...
        <div className="mb-6">
          ...
          {['rectangle', 'circle', 'triangle', 'star', 'hexagon', 'sticker', 'regularPolygon', 'trapezoid', 'parallelogram', 'triangle_right', 'cross', 'speech_bubble', 'speech_bubble_round', 'thought_bubble', 'callout', 'location', 'shield', 'banner', 'ribbon', 'search', 'diamond', 'frame'].includes(selectedElementData.type) && (
            <>
              <div className="mb-3">
                ...
                <div className="flex space-x-2 mb-3">
                  <button
                    ...
                    className={`p-2 rounded text-xs flex-1 ${selectedElementData.fillType === 'solid' ? 'bg-blue-100 text-blue-600 border border-blue-300' : 'bg-gray-100 border border-gray-300'
                      }`}
                  >
                    Solid Color
                  </button>
                  <button
                    ...
                    className={`p-2 rounded text-xs flex-1 ${selectedElementData.fillType === 'gradient' ? 'bg-blue-100 text-blue-600 border border-blue-300' : 'bg-gray-100 border border-gray-300'
                      }`}
                  >
                    Gradient
                  </button>
              ...
              <div className="mb-3">
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.textAlign === 'left' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.textAlign === 'center' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.textAlign === 'right' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
              ...
              <div className="mb-3">
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.fontWeight === 'bold' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.fontStyle === 'italic' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 p-2 rounded ${selectedElementData.textDecoration === 'underline' ? 'bg-blue-100 text-blue-600' : 'bg-gray-100'
                      }`}
                  >
          ...
          {/* Shape Properties */}
          {['rectangle', 'circle', 'triangle', 'star', 'hexagon', 'regularPolygon', 'trapezoid', 'parallelogram', 'triangle_right', 'cross', 'speech_bubble', 'speech_bubble_round', 'thought_bubble', 'callout', 'location', 'line', 'arrow', 'line_double', 'arrow_double', 'shield', 'banner', 'ribbon', 'search', 'diamond', 'frame'].includes(selectedElementData.type) && (
            <>
              <div className="mb-3">
          ...
          <div className="grid grid-cols-2 gap-2 mb-3">
            ...
            <button
              ...
              className={`p-2 rounded text-sm flex items-center justify-center ${lockedElements.has(selectedElement)
          ...
          {selectedElementData.type === 'frame' && selectedElementData.content && (
            <button
              onClick={() => updateElement(selectedElement, { content: null, contentType: null })}
              className="w-full p-2 bg-orange-100 text-orange-600 rounded text-sm hover:bg-orange-200 flex items-center justify-center mb-3"
            >
              Clear Frame Content
            </button>
          )}
