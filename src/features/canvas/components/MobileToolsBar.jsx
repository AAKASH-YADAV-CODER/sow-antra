...
import {
  ...
  Undo, Redo, Save, Film, Layers, Sparkles, Shapes,
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg z-30 overflow-x-auto overflow-y-hidden">
        <div className="flex items-center gap-1 p-2 min-w-max">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 px-3 py-2 rounded-lg touch-manipulation min-w-[60px] ${currentTool === 'select' ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-100'
              }`}
          >
